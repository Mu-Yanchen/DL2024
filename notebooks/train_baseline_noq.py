...
for ii in tqdm(range(20)):#(range(len(dataset))):
    ...
    response = [extract_html_content(out,test_data['ir'])]
...
json_file = open('/scratch/muyanchen/LayoutGeneration-main/LayoutPrompter/dataset/webui/processed/text/result_ir.json', mode='w')
